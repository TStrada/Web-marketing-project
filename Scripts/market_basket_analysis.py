...
sns.scatterplot(x = "support", y = "confidence", size = "lift", data = rules, sizes=(50, 200), hue = 'lift', palette = "coolwarm")
plt.legend(markerscale = 1)
plt.ylabel('Confidenza', fontsize = 12)
plt.xlabel('Supporto', fontsize = 12)
